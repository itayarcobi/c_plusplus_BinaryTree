...
int main() {
  ...
  tree_of_ints.add_left(1, 9)      // Now 9 is the left child of 1
  ...
  // .add_left(3, 6)  ;   
  // cout <<"first tree: "<<endl<< tree_of_ints << endl;  // Prints the tree in a reasonable format. For example:

  //    BinaryTree<int> tree=tree_of_ints;
  //   tree.add_root(18).add_left(18,35);
  //    cout <<"second tree: "<<endl<< tree << endl;  // Prints the tree in a reasonable format. For example:
  //    cout <<"first tree: "<<endl<< tree_of_ints << endl;  // Prints the tree in a reasonable format. For example:
